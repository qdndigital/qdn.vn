import {
  ...
  f as renderHead,
  u as unescapeHTML,
} from "./astro/server_D4avlH1o.mjs";
import "kleur/colors";
import "clsx";
/* empty css                         */
...
const $$Header = createComponent(
  ...
  "/sessions/beautiful-determined-gates/mnt/QDN/QDN_Astro/src/components/Header.astro",
  void 0,
);
...
const $$Footer = createComponent(
  ...
  "/sessions/beautiful-determined-gates/mnt/QDN/QDN_Astro/src/components/Footer.astro",
  void 0,
);
...
const $$Base = createComponent(
      ...
      "@graph": [
        {
          ...
          name: "QDN",
          url: "https://qdn.vn/",
          email: "quang.dinh@qdn.vn",
          description:
            "A product & AI studio building premium web, mobile and SaaS products. We use AI to turn an idea into a clickable mockup fast, then ship to market quickly.",
    ...
    return renderTemplate(
      _a ||
        (_a = __template([
          ...
          ">",
          '<link rel="canonical"',
          '><link rel="icon" href="/favicon.svg" type="image/svg+xml"><meta name="theme-color" content="#e9e7e2"><meta property="og:type" content="website"><meta property="og:site_name" content="QDN"><meta property="og:title"',
          ...
          '><link rel="sitemap" href="/sitemap-index.xml"><script type="application/ld+json">',
          "<\/script>",
          "</head> <body> ",
          " ",
          " ",
      ...
      noindex && renderTemplate`<meta name="robots" content="noindex,follow">`,
      addAttribute(canonical, "href"),
      addAttribute(title, "content"),
      addAttribute(description, "content"),
      addAttribute(canonical, "content"),
      addAttribute(ogImage, "content"),
      addAttribute(title, "content"),
      addAttribute(description, "content"),
      addAttribute(ogImage, "content"),
  ...
  "/sessions/beautiful-determined-gates/mnt/QDN/QDN_Astro/src/layouts/Base.astro",
  void 0,
);
